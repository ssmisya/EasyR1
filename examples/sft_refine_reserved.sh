...
### 设置为ray cluster的节点，将四个138换成ray cluster的节点名称
export NO_PROXY="localhost,127.0.0.1,10.140.37.138,10.138.0.0/16,10.1.0.0/16"
export no_proxy="localhost,127.0.0.1,10.140.37.138,10.138.0.0/16,10.1.0.0/16"
...
MODEL_PATH=/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-3B-Instruct-ToolSFTv1/checkpoint-100
###
checkpoint_dir="/mnt/petrelfs/sunhaoyu/visual-code/EasyR1/checkpoints/checkpoints_sft100_3b_refine"
